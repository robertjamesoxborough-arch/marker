    ...
    <GuideLayout>
      ...
      <div style={{ padding: '40px 0 32px', borderBottom: '3px solid var(--marker-black)' }}>
        ...
        <p style={{ fontSize: 15, color: 'var(--marker-mid)', lineHeight: 1.7, margin: '0 0 20px', maxWidth: 560 }}>
          Eight things to check before applying for any senior role — with exactly where to look, what to look for, and what the signal means. Do all eight in 30 minutes. Or spend three hours doing them badly.
        </p>
