    ...
    <div style={{ minHeight: '100vh', background: 'var(--marker-cream)', fontFamily: 'var(--font-body)' }}>
      ...
      <div style={{ maxWidth: 640, margin: '0 auto', padding: '0 24px 80px' }}>
        ...
        {[
          ...
          { q: 'Where does job data come from?', a: 'Live roles come from Adzuna, who aggregate listings from thousands of job boards nightly. The work-life balance reference carries only what each employer publishes about itself, its stated parental leave and office expectation; always verify directly with the employer.' },
